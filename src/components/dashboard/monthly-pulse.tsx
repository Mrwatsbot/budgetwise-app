...
export function MonthlyPulse({
  ...
  return (
    <div className="glass-card rounded-xl p-5 sm:p-6">
      {/* Header */}
      <div className="mb-5">
        <h2 className="text-lg font-display font-semibold mb-1">Monthly Pulse</h2>
      ...
      <div className="mb-6">
        ...
        <div className={`text-5xl font-display font-bold tabular-nums mb-1 ${getLeftToSpendColor()}`}>
      ...
      <div data-tour="allocation-bar" className="grid grid-cols-2 gap-3 mb-5">
        ...
        <div className="rounded-lg bg-secondary/20 border border-border/30 p-3">
          ...
          <p className={`text-lg font-display font-semibold ${leftToSpend >= 0 ? 'text-[#7aba5c]' : 'text-red-500'}`}>
